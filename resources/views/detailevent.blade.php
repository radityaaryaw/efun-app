                ...
                <table
                    ...
                    <tr style="border-bottom: 1px solid #ccc;">
                        ...
                        <td style="padding: 10px;">
                            {{ $event->tanggal_event }}
                        </td> <!-- DIISI DENGAN TANGGGAL EVENT-->
                    </tr>
                    <tr>
                        <td
                        ...
                        <div class="modal-content" style="border-radius: 12px;">
                            ...
                            <form action="/pembelian/store" method="POST"
                                ...
                                <div class="modal-body" style="padding: 25px;">
                                    ...
                                    <input type="hidden" name="kategori_id" value="{{ $event->kategori->id }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" id="jumlahTiketField{{ $event->id }}"
                                            ...
                                            onchange="updateTotal(this.value, {{ $event->harga_tiket }})">
                                        <p id="totalHarga" style="margin-top: 10px; color: #4389cf;">
                                            Total: Rp. {{ number_format($event->harga_tiket, 0, ',', '.') }}
                                        </p>
                                    </div>
                                    <script>
                                        function updateTotal(jumlah, harga) {
                                            const total = jumlah * harga;
                                            document.getElementById('totalHarga').innerHTML = 
                                                'Total: Rp. ' + total.toLocaleString('id-ID');
                                        }
                                    </script>
                                    <input type="hidden" name="total_harga" id="totalHargaField{{ $event->id }}" value="{{ $event->harga_tiket }}">
