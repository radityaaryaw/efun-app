        ...
        <div class="card-body">
          <div style="padding-top: 2px; display: flex; margin-bottom: 20px;">
            <div style="display: flex; align-items: flex-start; gap: 15px;">
              ...
              <div>
                <div style="font-weight: 600; font-size: 16px; color: #515151;">{{$item->judul}}</div>
                <div style="font-weight: 300; font-size: 14px; color: #777777;">{{$item->kategori->nama_kategori}} | {{$item->kategori->sub_kategori}}</div>
              </div>
            </div>
          </div>
          <p style="font-size: 14px; font-weight: 600; color: #4389cf; margin-bottom: 4px;">
            ...
            <tr>
                ...
                <td style="padding: 6px 0;">{{ date('d F Y', strtotime($item->tanggal_event)) }}</td>
            </tr>
            <tr>
