<aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- Dashboard User --}}
            <li class="nav-item">
                <a class="nav-link text-white {{ request()->routeIs('user.dash') ? 'active' : '' }}"
                    style="{{ request()->routeIs('user.dash') ? 'background: rgba(191, 191, 191, 0.4);' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ request()->routeIs('home') ? 'active' : '' }}"
                    style="{{ request()->routeIs('home') ? 'background: rgba(191, 191, 191, 0.4);' : '' }}"
                    href="{{ route('home') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- Tiket Event User --}}
            <li class="nav-item">
                <a class="nav-link text-white {{ request()->routeIs('user.pembelian.*') ? 'active' : '' }}"
                    style="{{ request()->routeIs('user.pembelian.*') ? 'background: rgba(191, 191, 191, 0.4);' : '' }}"
                    href="{{ route('user.pembelian.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
