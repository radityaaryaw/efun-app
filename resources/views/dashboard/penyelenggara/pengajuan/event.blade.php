    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        ...
        <div class="button-container" style="padding-bottom: 20px; padding-top: 10px; display: flex; justify-content: space-between; padding-right: 30px;">
            ...
            <form action="{{ route('admin.user.index') }}" method="GET" style="display: flex; align-items: center;">
                <input type="search" name="search" id="search" class="form-control" placeholder="Cari user..." style="font-size: 14px; width: 300px;" value="{{ request('search') }}">
                <button type="submit" class="btn" style="background-color:#acacac; color: #fff; font-size: 15px; margin-left: 5px;">
        ...
        <div class="table-container" style="font-family: 'Poppins', sans-serif; font-size: 13px;">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="max-width: 180px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $user->name }}</td>
                        <td>{{ $user->email }}</td>
                        ...
                        <td>
                            <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#updateUser{{ $user->id }}" style="font-size: 13px;">
            ...
            <div class="table-footer" style="padding-top: 10px; padding-left: 15px; font-family: 'Poppins', sans-serif; font-size: 13px;">
                {{ $users->links() }}
            </div>
        </div>
    </main>
