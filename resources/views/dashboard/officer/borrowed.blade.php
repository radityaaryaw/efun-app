    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="table-container" style="font-family: 'Poppins', sans-serif; font-size: 13px;">
                <table class="table">
                    <form action="{{ route('officerborrow') }}" method="GET">
                        <div class="input-group">
                            <div class="form-outline" data-mdb-input-init>
                                <input type="search" value="{{ request('search') }}" style="font-size: 14px; width: 400px;" name="search" id="search" class="form-control" placeholder="Cari data validasi disini .." />
                            </div>
                        ...
                        @foreach($borrow as $item)
                            <tr style="text-align: center">
                                ...
                                <td>
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#viewDetail{{$item->id}}"
                                            ...
                                            <div class="modal-content" style="border-radius: 12px;">
                                                <div class="modal-header">
                                                    <h5 style="margin-left: 15px; font-weight: 600; color:#515151; font-size: 17px;">
                                                        <i class="fas fa-info-circle" style="margin-right: 5px;"></i> Bukti Pembayaran
                                                    </h5>
                                                </div>
                                                <div class="modal-body" style="padding: 25px; text-align: left;">
                                                    <p style="font-size: 14px; font-weight: 500; color: #4389cf; margin-bottom: 4px;">Bukti Transfer</p>
                                                    <img src="{{ asset('img/cnth_bukti.png') }}" width="100%" style="border-radius: 8px; margin-bottom: 15px;">
                                                    ...
                                                    <table style="width: 100%; font-size: 13px; color: #515151; border-collapse: collapse; margin-bottom: 20px;">
                                                        <tr>
                                                            ...
                                                            <td style="padding: 6px 0;">Raditya Arya Wiguna</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding: 6px 0; font-weight: 500; width: 40%;">Jumlah Tiket</td>
                                                            <td style="padding: 6px 0;">3</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding: 6px 0; font-weight: 500;">Total Pembayaran</td>
                                                            <td style="padding: 6px 0;">Rp. 340.000</td>
                                                        </tr>
                                                    </table>
