                ...
                <div class="container-fluid py-3 px-3">
                    <nav aria-label="breadcrumb">
                        <h5 class="font-weight-bolder mb-0"
                            style="font-family: 'Poppins', sans-serif; color: #515151; font-weight:bold;">Tambah Pengajuan
                        </h5>
                ...
                <form action="{{ route('book.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="title" style="font-weight: 600; font-size: 14px;" class="form-label">Nama
                            Event</label>
                        <input type="text" style="font-size: 14px; border-radius: 15px; padding: 26px; margin-top: 10px;"
                            class="form-control" id="title" placeholder="Ketikkan nama event" name="title" required>
                    </div>
                    <div class="mb-3">
