    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                ...
                <div class="container-fluid py-3 px-3">
                    <nav aria-label="breadcrumb">
                        <h5 class="font-weight-bolder mb-0"
                            style="font-family: 'Poppins', sans-serif; color: #515151; font-weight:bold;">Laporan Data Event</h5>
            ...
            {{-- <div class="button-container" style="padding-bottom: 20px; padding-top: 10px; display: flex; justify-content: space-between; padding-right: 30px;">
                ...
                <form action="{{route('borrowExcel')}}" method="POST">
                    @csrf
                ...
                <table class="table">
                    <form action="{{route('lending')}}" method="GET">
                        ...
                        <div class="form-outline" data-mdb-input-init>
                          <input type="search" value="{{ request('search') }}" style="font-size: 14px; width: 400px;" name="search" id="search" class="form-control" placeholder="Cari data event disini .." />
                        </div>
                    ...
                    <tbody>
                        @foreach($borrow as $item)
                            <tr style="text-align: center">
                                ...
                                <td>{{$item->book->title}}</td>
                                <td style="color: {{ $item->lending_status === 'Dipinjam' ? 'red' : 'green' }}; font-weight: 600;">
                                    {{$item->lending_status}}
                                </td>
                            </tr>
                    @endforeach
