    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
                ...
                <div class="container-fluid py-3 px-3">
                    <nav aria-label="breadcrumb">
                        <h5 class="font-weight-bolder mb-0"
                            style="font-family: 'Poppins', sans-serif; color: #515151; font-weight:bold;">Kategori Event</h5>
            ...
            <div class="table-container" style="font-family: 'Poppins', sans-serif; font-size: 13px; margin-bottom: 40px;">
                <form action="{{route('category.store')}}" method="post">
                    ...
                    <div style="display: flex; gap: 20px; align-items: flex-start;">
                        <!-- Dropdown Role di kiri -->
                        <div style="flex: 1; position: relative;">
                            <label for="name_category" style="font-weight: 500; font-size: 14px; color:#515151;" class="form-label">Nama Kategori</label>
                                                    <select class="form-control" style="font-size: 14px; border-radius: 10px; margin-top: 10px; color:#868686;" id="" name="" value="">
                        ...
                        <div style="flex: 1;">
                            <label for="name_category" style="font-weight: 500; font-size: 14px; color:#515151;" class="form-label">Sub Kategori</label>
                            <input type="text" style="font-size: 14px; padding: 18  px; border-radius: 10px; margin-top: 10px; color:#868686;" class="form-control" id="name_category" placeholder="Ketikkan sub kategori" name="name_category" required>
                        </div>
                    </div>
            ...
            {{-- <div class="button-container" style="padding-left: 20px; padding-bottom: 20px; padding-top: 10px; display: flex; justify-content: flex-start;">
                <form action="{{route('exportcategory')}}" method="POST" target="__blank">
                    @csrf
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <form action="{{route('category.destroy', $c->id)}}" method="post">
                            <div class="column">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#update{{$c->id}}"
