                ...
                <div class="container-fluid py-3 px-3">
                    <nav aria-label="breadcrumb">
                        <h5 class="font-weight-bolder mb-0"
                            style="font-family: 'Poppins', sans-serif; color: #515151; font-weight:bold;">Pengajuan Event
                        </h5>
                    </nav>
                    ...
                    <div class="input-group">
                        <div class="form-outline" data-mdb-input-init>
                            <input type="search" value="{{ request('search') }}" style="font-size: 14px; width: 400px;"
                                ...
                                placeholder="Cari data pengajuan disini .." />
                        </div>
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        ...
                                        <p style="margin-top: -12px; font-size:13px; font-weight: 400">{{ $b->author }}
                                        </p>
                                    </div>
                                </td>
                                <td>{{ $b->publisher }}</td>
                                ...
                                <td>
                                    <form action="" method="POST" style="display: inline;">
                                        @csrf
                                        <button type="submit"
                                            style="font-size: 13px; background-color: #D2F7C9; color: #60AB32; padding: 10px 20px; border: none; border-radius: 10px; font-weight: 500; cursor: pointer; font-family: 'Poppins', sans-serif; margin-left: 12px;">
                                    ...
                                    <form action="" method="POST" style="display: inline; margin-left: 10px;">
                                        @csrf
                                        <button type="submit"
                                            style="font-size: 13px; background-color: #f7cdc9; color: #ab3232; padding: 10px 20px; border: none; border-radius: 10px; font-weight: 500; cursor: pointer; font-family: 'Poppins', sans-serif; margin-left: 12px;">
                                    ...
                                    <button type="button" data-bs-toggle="modal"
                                        data-bs-target="#viewDetail{{ $b->id }}" class="btn-riwayat"
                                        style="font-size: 13px; background-color: #007bff; margin-left: 10px;">
                                        <i class="fa-solid fa-eye"></i>
                                    </button>

                                    <!-- Modal Detail Pengajuan -->
                                    <div class="modal fade" id="viewDetail{{ $b->id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="viewDetailLabel{{ $b->id }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content" style="border-radius: 12px;">
                                                ...
                                                <div class="modal-body" style="padding: 25px;">
                                                    <img src="{{ asset('img/contoh.png') }}" width="100%"
                                                        style="border-radius: 8px; margin-bottom: 15px;">

                                                    <div
                                                        style="display: flex; align-items: flex-start; gap: 15px; margin-bottom: 20px;">
                                                        <i class="fa-solid fa-map-location-dot"
                                                            style="font-size: 24px; color: #dc5496; margin-top: 4px;"></i>
                                                        <div>
                                                            <div
                                                                style="font-weight: 600; font-size: 14px; color: #ff74b7;">
                                                                Taman Safari Night</div>
                                                            <div
                                                                style="font-weight: 300; font-size: 12px; color: #ff94c8;">
                                                                Kategori Atraksi</div>
                                                        </div>
                                                    </div>
                                                    <p
                                                        style="font-size: 14px; font-weight: 500; color: #4389cf; margin-bottom: 4px;">
                                                        Deskripsi Event</p>
                                                    <p
                                                        style="font-weight: 300; font-size: 13px; color: #515151; margin-top: 0; white-space: normal; word-wrap: break-word;">
                                                        Taman Safari Night atau Night Safari adalah program wisata yang
                                                        menawarkan pengalaman melihat satwa liar di malam hari, terutama
                                                        satwa nokturnal. Pengalaman ini berbeda dengan mengunjungi kebun
                                                        binatang pada siang hari, di mana pengunjung dapat menikmati
                                                        aktivitas satwa yang berbeda di malam hari.
                                                    </p>
                                                    ...
                                                    <p
                                                        ...
                                                        Informasi Event</p>
                                                    <table
                                                        style="width: 100%; font-size: 13px; color: #515151; border-collapse: collapse; margin-bottom: 20px;">
                                                        <tr>
                                                            <td style="padding: 6px 0; font-weight: 500;">Tanggal Event
                                                            </td>
                                                            <td style="padding: 6px 0;">15 Juni 2025</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding: 6px 0; font-weight: 500; width: 40%;">Harga
                                                                Tiket</td>
                        ...
                        @empty
                            <div class="alert alert-danger" style="color: white;">
                                <i class="fas fa-exclamation-circle" style="margin-right: 10px;"></i> Data buku belum
                                tersedia
                            </div>
                        @endforelse
                    </tbody>
